                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => navigate("/updatedoctor")} className="btn1 btn-primary">UPDATE</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => navigate("/updatetimetable")} className="btn1 btn-info">UPDATE</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => navigate("/updatetimetable")} className="btn1 btn-success">CHANGE</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => navigate("/doctorcurrentappointments")} className="btn1 btn-warning">CHECK</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-sm-6">
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <button onClick={() => navigate("/doctorcurrentappointments")} className="btn1 btn-danger">CANCEL</button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6">
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <button onClick={() => navigate("/doctorappointmenthistory")} className="btn1 btn-primary">CHECK</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-sm-6">
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <button onClick={() => navigate("/changepassworddoctor")} className="btn1 btn-success">CHANGE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
